...
function FindSimilarHighSchool(props) {
  ...
  async function findhandler(event){
    ...
    return (
      ...
      <class> 
        <Title className= "title_similarHighSchool" > Find Similar High School</Title>

        <div className = 'similarHightSchoolPage'><Title level={4}> Please select a high school</Title>
