...
function Profile(props) {
    ...
    //////all state
    const allstates = <Select style = {{width: 200}} disabled={props.DisableBasic}>
    ...
    const classyear =<Select style = {{width: 200}} disabled={props.DisableBasic}>{classyears}</Select>;
    /////////////////////
            ...
            <div>
                ...
                <TabPane></TabPane>
                    <TabPane className="profile_tabpane" tab="Basic Info" key="1">
                        ...
                        >   <Title className = "title_profile">Basic Infomation</Title>
                            <Form.Item style = {{margin: '0 480px', width: 200}} label="Username" name="username" rules={[ {required: true},]}>
                              <Input disabled={props.DisableBasic}/> 
                            </Form.Item>

                            <Form.Item style  = {{margin: '0 480px', width: 200}} label="Residence State" name="ResidenceState">{allstates}</Form.Item>
                            
                            <Form.Item style = {{margin: '0 480px', width: 200}} label="High School" name="HighSchool"><Input disabled={props.DisableBasic} /></Form.Item>
                            
                            <Form.Item style = {{margin: '0 480px', width: 200}} label="High School City" name="HighSchoolCity"><Input disabled={props.DisableBasic}/></Form.Item>
                            
                            <Form.Item style = {{margin: '0 480px', width: 200}} label="High School State" name="HighSchoolState">{allstates}</Form.Item>
                          
                            <Form.Item style = {{margin: '0 480px', width: 200}} label="College Class" name="CollegeClass">{classyear}</Form.Item>
                           
                            <Form.Item style = {{margin: '0 480px', width: 200}} label="First Major" name="FirstMajor"><Input disabled={props.DisableBasic}/></Form.Item>
                            
                            <Form.Item style = {{margin: '0 480px', width: 200}} label="Second Major" name="SecondMajor"><Input disabled={props.DisableBasic}/></Form.Item>
                            
                            <Form.Item >
                              <Button style = {{margin: '0 480px'}} type="primary" htmlType="submit" shape="round" icon={<EditOutlined />}  >
                    ...
                    <TabPane className="profile_tabpane" tab="Scores & Grades" key="2">
                      <Form
                          ...
                          <Form.Item >
                              <Button style = {{margin: '0 490px'}} type="primary" htmlType="submit" shape="round" icon={<EditOutlined />} >
